export interface LeaseActionsSubmitModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSign: () => void;
  ...
  const LeaseActionsSubmitModal: React.FC<LeaseActionsSubmitModalProps> = ({
    isOpen,
    onClose,
    onSign,
    header,
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div className="relative transform rounded-lg bg-neutral-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all ml-auto sm:my-8 w-2/3 h-full sm:p-6">
              {/* Close button */}
  ...
  export default LeaseActionsSubmitModal;
