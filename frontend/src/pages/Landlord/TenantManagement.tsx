      ...
      <div className="flex flex-col gap-2">
        <div className="flex h-96 rounded-lg overflow-hidden gap-2">
          <div className="bg-neutral-900 w-127 rounded-lg overflow-hidden relative">
              {/* <button className="text-orange-100 bg-nuetral-600 w-3/4 h-10 rounded-lg 
                                border-2 hover:bg-orange-500">Button 1</button>
              <button className="text-orange-100 bg-nuetral-600 w-3/4 h-10 rounded-lg 
                                border-2 hover:bg-orange-500">Button 2</button>
              <button className="text-orange-100 bg-nuetral-600 w-3/4 h-10 rounded-lg 
                                border-2 hover:bg-orange-500">Button 3</button> */}
              <div>
